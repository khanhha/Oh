...
# class NormalSpaceSampling : public FilterIndices<PointT>
# khanh
cdef extern from "pcl/filters/octree_sampling.h" namespace "pcl":
    cdef cppclass OctreeSampling[T](Filter[T]):
        ctypedef enum ResampleMethod:
            UNIFORM, NONUNIFORM_MAX_POINTS_PER_LEAF, NONUNIFORM_NORMAL_THRESHOLD
        ...
        void setMaxPointsPerLeaf(size_t n);
        void setSampleRadiusSearch(double radius);
        void setResampleMethod(ResampleMethod method);
